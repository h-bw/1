            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                <template #default="scope">
                    <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                               v-hasPermi="['snack:cart:edit']">修改
                    </el-button>
                    <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)"
                               v-hasPermi="['snack:cart:remove']">删除
                    </el-button>
                </template>
            </el-table-column>
        </el-table>
...
import {listCart, getCart, delCart, addCart, updateCart} from "@/api/snack/cart"
...
const data = reactive({
    ...
    upload: {
        ...
        // 上传的地址
        url: baseURL + "/snack/cart/importData"
    }
})
...
/** 导出按钮操作 */
const handleExport = () => {
    proxy.download('snack/cart/export', {
        ...queryParams.value
...
const importTemplate = () => {
    proxy.download('snack/cart/importTemplate', {}, `template_${new Date().getTime()}.xlsx`)
}
