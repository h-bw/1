        ...
        <el-row :gutter="10" class="mb8">
            ...
            <el-col :span="1.5">
                <el-button
                        ...
                        :disabled="multiple"
                        @click="handleDelete"
                        v-hasPermi="['snack:address:remove']"
                >删除
                </el-button>
            </el-col>
            <el-col :span="1.5">
                <el-button
                        ...
                        icon="Download"
                        @click="handleExport"
                        v-hasPermi="['snack:address:export']"
                >导出
                </el-button>
            </el-col>
            <el-col :span="1.5">
            ...
            <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
                <template #default="scope">
                    <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)"
                               v-hasPermi="['snack:address:edit']">修改
                    </el-button>
                    <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)"
                               v-hasPermi="['snack:address:remove']">删除
                    </el-button>
                </template>
            </el-table-column>
        </el-table>
...
import {listAddress, getAddress, delAddress, addAddress, updateAddress} from "@/api/snack/address"
...
const data = reactive({
    ...
    upload: {
        ...
        // 上传的地址
        url: baseURL + "/snack/address/importData"
    }
})
...
/** 导出按钮操作 */
const handleExport = () => {
    proxy.download('snack/address/export', {
        ...queryParams.value
...
const importTemplate = () => {
    proxy.download('snack/address/importTemplate', {}, `template_${new Date().getTime()}.xlsx`)
}

/** 导入按钮操作 */
const handleImport = () => {
    upload.value.title = "收货地址导入";
